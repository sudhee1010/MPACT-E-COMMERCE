...
export default function AdminReviews() {
  ...
  return (
    <div className="min-h-screen bg-[#1e1e1e] text-white p-10 relative">
      <h2 className="text-2xl font-bold mb-8">Review Analytics</h2>

      {/* ================= Analytics Cards ================= */}
      {analytics && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
          <Card title="Total Reviews" value={analytics.total} />
          <Card title="Approved" value={analytics.approved} />
          <Card title="Pending" value={analytics.pending} />
          <Card title="Average Rating" value={`${analytics.average} ⭐`} />
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="bg-[#2b2b2b] p-6 rounded-xl w-96 border border-yellow-400">
            ...
            <p className="text-gray-300 mb-6">
              Are you sure you want to {modalType} this review?
            </p>
