  ...
  <DialogContent className="bg-[#2a2a2a] border-gray-700 text-white max-w-md">
    ...
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-400">
        This action will deactivate the category and can be reversed later.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {categories.map((category) => (
          <div
            key={category._id}
            className="bg-[#2a2a2a] border border-yellow-400/20 rounded-lg p-6 hover:border-yellow-400/40 transition-all"
          >
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 bg-yellow-400/20 rounded-lg flex items-center justify-center">
                <FolderOpen size={24} className="text-yellow-400" />
