...
//         .nav-logo {
//            font-family: 'Dimitri', 'Impact', sans-serif;
//             font-size: 40px;
//             font-weight: 90;
//             color: black;
//             text-transform: uppercase;
//             letter-spacing: 2px;
//             // -webkit-text-stroke: 1px #f5e600;
//       }
...
//         /* Removed background and box-shadow from active state */
...
//         /* Added hover scale effect for text */
